...
namespace Database_project
{
    public class Book
    {
        ...
        /// </summary>
        public Book(int id,int genre_id,int autor_id,int publisher_id, string name, string release_date)
        {
            this.ID = id;
        ...
        /// </summary>
        public Book(int genre_id, int autor_id,int publisher_id, string name, string release_date)
        {
            this.ID = 0;
            this.genre_id = genre_id;
            this.autor_id = autor_id;
        ...
        {
            return $"{ID}. {genre_id} {autor_id} {publisher_id} {name} {release_date}";
        }
    }
}
